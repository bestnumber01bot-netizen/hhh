...
BOT_TOKEN = "8527654676:AAFA8alHq_8iOEoWsacaiFvioklLGGA4k4o"
API_KEY = "ZNX_T2FHH4O17W78E4UY6CCXVNUT"  # জেনেক্স এপিআই কী
...
WELCOME_MESSAGE = "✨ **WELCOME TO 𝐁𝐞𝐬𝐭 𝐍𝐮𝐦𝐛𝐞𝐫 𝐁𝐨𝐭 NUMBER BOT** ✨\n━━━━━━━━━━━━━━━━━━━━━━\n🚀 **START INSTANT OTP RECEPTION NOW!** 🚀"
...
def load_settings():
    if not os.path.exists(SETTINGS_FILE):
        default = {
            ...
            "otp_group_url": "https://t.me/bestnumber_OTP",
            "channel_url": "https://t.me/Best_Number01l0",
            "support_username": "@Md_Eamin_14",
            ...
            "force_join_channels": ["@Best_Number01"], # ফোর্স জয়েন চ্যানেলসমূহ
    ...
    try:
        ...
        return {
            ...
            "welcome_message": WELCOME_MESSAGE,
            "otp_group_url": "https://t.me/bestnumber_OTP",
            "channel_url": "https://t.me/Best_Number01",
            "support_username": "@Md_Eamin_14",
            "maintenance_mode": False,
            "min_withdraw": 0.5,
            "max_withdraw": 100.0,
            ...
            "force_join_channels": ["@Best_Number01"],
...
async def show_app_selection(update, context):
    ...
    if is_user_banned(uid):
        settings = load_settings()
        support = settings.get("support_username", "@Md_Eamin_14")
...
async def support_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    settings = load_settings()
    support_user = settings.get("support_username", "@Md_Eamin_14")
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("👨‍💻 DEVELOPER", url="https://t.me/rahi455", style="primary")]
    ])
            ...
            if "data" in res and "otps" in res["data"]:
                ...
                for otp in otps:
                    ...
                    if (num in active_numbers and 
                        ...
                        channel_url = settings.get("channel_url", "https://t.me/Best_Number01")
                        ...
                        user_otp_keyboard = InlineKeyboardMarkup([
                            ...
                            [
                                ...
                                InlineKeyboardButton("✔️ NUMBER ↗", url="http://t.me/Best_Number01_Bot", style="primary")
                            ]
                        ])
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                InlineKeyboardButton("‼️ PANEL", url="https://t.me/Best_Number01_Bot", style="danger"),
                                InlineKeyboardButton("📢 CHANNEL", url=channel_url, style="primary")
                            ]
                        ])
...
async def process_auto_number(update, context, range_text):
    ...
    try:
        ...
        settings = load_settings()
        otp_group_url = settings.get("otp_group_url", "https://t.me/bestnumber_OTP")
...
async def process_numbers(update, context, range_text, count, edit_message=None):
    ...
    try:
        ...
        settings = load_settings()
        otp_group_url = settings.get("otp_group_url", "https://t.me/bestnumber_OTPS")
